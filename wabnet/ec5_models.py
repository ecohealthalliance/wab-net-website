...
class x_field_data_forms_x(models.Model):
    ...
    x_1_Country_x = models.TextField(verbose_name='Country')
    ...
    x_6_Weather_conditions_x = models.TextField(verbose_name='Weather conditions prior to and during trapping?')
    x_7_Time_trapping_bega_x = models.TextField(verbose_name='Time trapping began (nets open)?')
    x_8_Time_trapping_ende_x = models.TextField(verbose_name='Time trapping ended (nets closed)?')
    x_9_Number_of_26_meter_x = models.TextField(verbose_name='Number of 2.6 meter nets?')
    x_10_Number_of_4_meter_x = models.TextField(verbose_name='Number of 4 meter nets?')
    x_11_Number_of_6_meter_x = models.TextField(verbose_name='Number of 6 meter nets?')
    x_12_Number_of_9_meter_x = models.TextField(verbose_name='Number of 9 meter nets?')
    x_13_Number_of_12_mete_x = models.TextField(verbose_name='Number of 12 meter nets?')
    x_14_Number_of_harp_tr_x = models.TextField(verbose_name='Number of harp traps?')


class x_15_Site_characteriza_x(models.Model):
    name = 'Site characterization '
    ec5_is_branch = True
    ec5_ref = '0676a95106ee4c3594ea16975fdbe3ba_5aeb50c6d334a_5aeb5a485aa2c'
    created_at = models.TextField()
    created_by = models.TextField()
    title = models.TextField()
    parent = models.ForeignKey(x_field_data_forms_x, on_delete=models.CASCADE)
    x_16_Date_of_site_char_x = models.TextField(verbose_name='Date of site characterization')
    x_17_Site_type_x = models.TextField(verbose_name='Site type')
    x_18_Specify_other_sit_x = models.TextField(verbose_name='Specify "other" site type')
    x_19_Guano_present_at_x = models.TextField(verbose_name='Guano present at site?')
    x_20_Estimated_human_p_x = models.TextField(verbose_name='Estimated human population size at site')
    x_21_Bathuman_interfac_x = models.TextField(verbose_name='Bat-human interface (check all that apply)')
    x_22_If_natural_area_w_x = models.TextField(verbose_name='If natural area, what setting?')
    x_23_If_forest_what_is_x = models.TextField(verbose_name='If forest, what is the estimated area?')
    x_24_If_forest_what_co_x = models.TextField(verbose_name='If forest, what condition is the forest?')
    x_25_If_cave_what_is_t_x = models.TextField(verbose_name='If cave, what is the estimated length of the cave?')
    x_26_If_cave_what_is_t_x = models.TextField(verbose_name='If cave, what is the structural heterogeneity of the cave?')
    x_27_Other_wildlife_sp_x = models.TextField(verbose_name='Other wildlife species observed at the site?')
    x_28_List_other_wildli_x = models.TextField(verbose_name='List other wildlife observed, be specific.')
    x_29_Domestic_animals_x = models.TextField(verbose_name='Domestic animals observed at the site?')
    x_30_List_domestic_ani_x = models.TextField(verbose_name='List domestic animals observed, be specific.')
    x_31_Is_water_present_x = models.TextField(verbose_name='Is water present at the site?')
    x_32_Is_water_shared_b_x = models.TextField(verbose_name='Is water shared between animals/wildlife and humans?')
    x_33_Site_accessibilit_x = models.TextField(verbose_name='Site accessibility')
    x_34_Site_accommodatio_x = models.TextField(verbose_name='Site accommodations for humans')
    x_35_Other_accommodati_x = models.TextField(verbose_name='Other accommodations observed, but not listed above')
    x_36_Frequency_of_huma_x = models.TextField(verbose_name='Frequency of human visitation to the site')
    x_37_Evidence_of_distu_x = models.TextField(verbose_name='Evidence of disturbance (select all that apply)')
    x_38_Other_evidence_of_x = models.TextField(verbose_name='Other evidence of disturbance, but not listed above')
    x_39_Observed_in_1_km_x = models.TextField(verbose_name='Observed in 1 km radius of site')
    x_40_Other_structures_x = models.TextField(verbose_name='Other structures observed in 1 km radius, but not listed above')
    x_41_Site_photographs_x = models.FileField(upload_to='ec5/', verbose_name='Site photographs')
    x_42_Site_video_x = models.FileField(upload_to='ec5/', verbose_name='Site video')


class x_43_Bat_capture_data_x(models.Model):
    name = 'Bat capture data'
    ec5_is_branch = True
    ec5_ref = '0676a95106ee4c3594ea16975fdbe3ba_5aeb50c6d334a_5aeb5ab65aa2e'
    created_at = models.TextField()
    created_by = models.TextField()
    title = models.TextField()
    parent = models.ForeignKey(x_field_data_forms_x, on_delete=models.CASCADE)
...
class x_82_Bat_acoustic_data_x(models.Model):
    ...
    ec5_is_branch = True
    ec5_ref = '0676a95106ee4c3594ea16975fdbe3ba_5aeb50c6d334a_5af087872284e'
    created_at = models.TextField()
    created_by = models.TextField()
    title = models.TextField()
    parent = models.ForeignKey(x_field_data_forms_x, on_delete=models.CASCADE)
...
class x_93_Bat_necropsy_form_x(models.Model):
    ...
    ec5_is_branch = True
    ec5_ref = '0676a95106ee4c3594ea16975fdbe3ba_5aeb50c6d334a_5af0878a2284f'
    created_at = models.TextField()
    created_by = models.TextField()
    title = models.TextField()
    parent = models.ForeignKey(x_field_data_forms_x, on_delete=models.CASCADE)
...
class x_100_Lab_results_data_x(models.Model):
    ...
    ec5_is_branch = True
    ec5_ref = '0676a95106ee4c3594ea16975fdbe3ba_5aeb50c6d334a_5aeb619e9a9eb'
    created_at = models.TextField()
    created_by = models.TextField()
    title = models.TextField()
    parent = models.ForeignKey(x_field_data_forms_x, on_delete=models.CASCADE)
