...
class BatData(models.Model):
    ...
    x_65_Specify_Other_bat_x = models.TextField(verbose_name='Specify "Other" bat family')
    ...
    x_74_Family_Rhinopomat_x = models.TextField(verbose_name='Family: Rhinopomatidae')
    x_75_Family_Vespertili_x = models.TextField(verbose_name='Family: Vespertilionidae')
    x_76_Specify_Other_bat_x = models.TextField(verbose_name='Specify "Other" bat species')
    x_77_Age_x = models.TextField(verbose_name='Age')
    x_78_Sex_x = models.TextField(verbose_name='Sex')
    x_79_Reproductive_stat_x = models.TextField(verbose_name='Reproductive status: Male')
    x_80_Reproductive_stat_x = models.TextField(verbose_name='Reproductive status: Female')
    x_82_Forearm_length_mm_x = models.TextField(verbose_name='Forearm length (mm)')
    x_83_Body_mass_g_x = models.TextField(verbose_name='Body mass (g)')
    x_84_Attached_pup_x = models.TextField(verbose_name='Attached pup?')
    x_85_Ear_length_mm_x = models.TextField(verbose_name='Ear length (mm)')
    x_86_Tail_length_mm_x = models.TextField(verbose_name='Tail length (mm)')
    x_87_Foot_length_mm_x = models.TextField(verbose_name='Foot length (mm)')
    x_88_Head_body_length_x = models.TextField(verbose_name='Head & body length (mm)')
    x_89_Other_morphologic_x = models.TextField(verbose_name='Other morphological measurements, be specific')
    x_91_Picture_1_x = models.FileField(upload_to='ec5/', verbose_name='Picture 1')
    x_92_Picture_2_x = models.FileField(upload_to='ec5/', verbose_name='Picture 2')
    x_93_Picture_3_x = models.FileField(upload_to='ec5/', verbose_name='Picture 3')
    x_94_Picture_4_x = models.FileField(upload_to='ec5/', verbose_name='Picture 4')
    x_95_Video_1_x = models.FileField(upload_to='ec5/', verbose_name='Video 1')
    x_96_Video_2_x = models.FileField(upload_to='ec5/', verbose_name='Video 2')
    x_97_Collect_diagnosti_x = models.TextField(verbose_name='Collect diagnostic samples - swabs, urine, feces, blood?')
    x_98_Collect_ORAL_swab_x = models.TextField(verbose_name='Collect ORAL swabs?')
    x_100_SAMPLE_1_Oral_sw_x = models.TextField(verbose_name='SAMPLE 1: Oral swab [AnimalID.OS1]')
    x_101_SAMPLE_2_Oral_sw_x = models.TextField(verbose_name='SAMPLE 2: Oral swab [AnimalID.OS2)')
    x_102_Collect_FECES_fr_x = models.TextField(verbose_name='Collect FECES (fresh) or RECTAL swabs?')
    x_104_Sample_1_SAMPLE_x = models.TextField(verbose_name='Sample 1: SAMPLE TYPE')
    x_105_Sample_2_SAMPLE_x = models.TextField(verbose_name='Sample 2: SAMPLE TYPE')
    x_106_Sample_1_STORAGE_x = models.TextField(verbose_name='Sample 1: STORAGE MEDIA')
    x_107_Sample_2_STORAGE_x = models.TextField(verbose_name='Sample 2: STORAGE MEDIA')
    x_108_Collect_URINE_UR_x = models.TextField(verbose_name='Collect URINE (UR) in RNALater?')
    x_109_Collect_BLOOD_x = models.TextField(verbose_name='Collect BLOOD?')
    x_111_Whole_blood_WB_s_x = models.TextField(verbose_name='Whole blood (WB) stored in RNAlater')
    x_112_Whole_blood_WB_s_x = models.TextField(verbose_name='Whole blood (WB) stored in TRIzol')
    x_113_Estimate_microli_x = models.IntegerField(verbose_name='Estimate microliters of blood drawn', blank=True, null=True)
    x_114_Blood_plasma_BP_x = models.TextField(verbose_name='Blood plasma (BP) stored in RNAlater')
    x_115_Prepare_BLOOD_S_x = models.TextField(verbose_name='Prepare BLOOD - SMEAR?')
    x_116_Collect_WING_BIO_x = models.TextField(verbose_name='Collect WING BIOPSY PUNCH?')
    x_117_Collect_OTHER_sa_x = models.TextField(verbose_name='Collect OTHER samples (eg. ectoparasites)')
    x_118_OTHER_samples_co_x = models.TextField(verbose_name='OTHER samples collected')
    x_119_OTHER_samples_co_x = models.TextField(verbose_name='OTHER samples collected not included on the list')
    x_120_Acoustic_recordi_x = models.TextField(verbose_name='Acoustic recordings taken?')
    x_130_Necropsy_or_spec_x = models.TextField(verbose_name='Necropsy or specimen voucher performed?')
    x_132_Date_necropsy_pe_x = models.TextField(verbose_name='Date necropsy performed')
    x_133_Person_performin_x = models.TextField(verbose_name='Person performing the necropsy')
    x_134_Samples_collecte_x = models.TextField(verbose_name='Samples collected during necropsy (store in RNAlater)')
    x_135_Bat_prepared_as_x = models.TextField(verbose_name='Bat prepared as museum specimen?')
    x_136_If_yes_deposited_x = models.TextField(verbose_name='If yes, deposited at what facility?')
    x_137_Additional_infor_x = models.TextField(verbose_name='Additional information noted')


class x_121_Acoustic_recordi_x(models.Model):
    keywords = GenericRelation(entity_keywords_model.EntityKeywords)
    ...
    x_122_Recording_equipm_x = models.TextField(verbose_name='Recording equipment used')
    x_123_Site_conditions_x = models.TextField(verbose_name='Site conditions where recording was taken')
    x_124_Specify_other_si_x = models.TextField(verbose_name='Specify other site conditions')
    x_125_Recording_method_x = models.TextField(verbose_name='Recording method')
    x_126_Acoustic_recordi_x = models.FileField(upload_to='ec5/', verbose_name='Acoustic recording 1')
    x_127_Acoustic_recordi_x = models.FileField(upload_to='ec5/', verbose_name='Acoustic recording 2')
    x_128_Acoustic_recordi_x = models.FileField(upload_to='ec5/', verbose_name='Acoustic recording 3')
    x_129_File_numbers_typ_x = models.TextField(verbose_name='File number(s), typically xxxx.wav')
