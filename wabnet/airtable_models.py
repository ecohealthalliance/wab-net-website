...
class Screening(models.Model):
    ...
    rerun3_gel_electrophoresis_results = models.TextField(verbose_name='RE-RUN 3 Gel electrophoresis result', null=True)
    rerun3_gel_photo_labeled = models.TextField(verbose_name='RE-RUN 3 Gel photo - labeled', null=True)
    rerun3_date_confirmation_test = models.DateTimeField(verbose_name='RE-RUN 3 Date of sequencing', null=True)
    rerun3_confirmation_test_results = models.TextField(verbose_name='RE-RUN 3 Sequencing result', null=True)
    rerun3_confirmation_test_results_other = models.TextField(verbose_name='RE-RUN 3 Sequencing result - if "Other"', null=True)
    rerun3_raw_cov_sequence_txt = models.TextField(verbose_name='RE-RUN 3 Raw CoV sequence - .txt files', null=True)
    rerun3_raw_cov_sequence_ab1 = models.TextField(verbose_name='RE-RUN 3 Raw CoV sequence - .ab1 files', null=True)
    rerun3_raw_cov_sequence_pdf = models.TextField(verbose_name='RE-RUN 3 Raw CoV sequence - .pdf files', null=True)
    rerun3_aligned_cov_sequence_submitted_to_blast = models.TextField(verbose_name='RE-RUN 3 Aligned CoV sequence (.fasta file) submitted to BLAST', null=True)
    rerun3_query_cover_top_BLAST_match = models.FloatField(verbose_name='RE-RUN 3 Query cover (%) for top BLAST match', null=True)
    rerun3_percent_identity_top_BLAST_match = models.FloatField(verbose_name='RE-RUN 3 Percent identity (%) for top BLAST match', null=True)
    rerun3_screenshot_top_5_BLAST_matches = models.TextField(verbose_name='RE-RUN 3 Screenshot photo of top 5 BLAST matches', null=True)
