...
class Georgia_screening(models.Model):
    ...
    date_RNA_extraction = models.DateTimeField(verbose_name='Date of RNA extraction')
    ...
    date_rtpcr_1 = models.DateTimeField(verbose_name='Date RT-PCR Method 1 performed')
    performed_rtpcr_2 = models.TextField(verbose_name='Performed RT-PCR Method 2 [RT (cDNA) + PCR]? (RSS only)')
    date_rtpcr_2 = models.DateTimeField(verbose_name='Date RT-PCR Method 2 performed (RSS only)')
    date_gel_electrophoresis = models.DateTimeField(verbose_name='Date of gel electrophoresis')
    ...
    date_confirmation_test = models.DateTimeField(verbose_name='Date of confirmation test')
    ...
    query_cover_top_BLAST_match = models.FloatField(verbose_name='Query cover (%) for top BLAST match')
    percent_identity_top_BLAST_match = models.FloatField(verbose_name='Percent identity (%) for top BLAST match')
...
class Georgia_barcoding(models.Model):
    animal_id = models.TextField(verbose_name='Unique ANIMAL ID')
    date_rtpcr = models.DateTimeField(verbose_name='Date of RT-PCR')
    date_gel_electrophoresis = models.DateTimeField(verbose_name='Date of gel electrophoresis')
    ...
    gel_photo_labeled = models.FileField(upload_to='airtable_georgia/', verbose_name='Gel photo - labeled')
    date_sequenced = models.DateTimeField(verbose_name='Date of sequencing')
