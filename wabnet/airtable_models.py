...
class Screening(models.Model):
    ...
    rerun2_sample = models.TextField(verbose_name='Was sample RE-RUN2?', null=True)
    rerun2_sample_id = models.TextField(verbose_name='RE-RUN2 SAMPLE ID', null=True)
    rerun2_sample_type = models.TextField(verbose_name='RE-RUN2 Sample type', null=True)
    rerun2_sample_storage_media = models.TextField(verbose_name='RE-RUN2 Sample storage media', null=True)
    rerun2_date_RNA_extraction = models.DateTimeField(verbose_name='RE-RUN2 Date of RNA extraction', null=True)
    rerun2_RNA_extraction_method = models.TextField(verbose_name='RE-RUN2 RNA extraction method', null=True)
    rerun2_date_rtpcr_1 = models.DateTimeField(verbose_name='RE-RUN2 Date of RT-PCR', null=True)
    rerun2_date_gel_electrophoresis = models.DateTimeField(verbose_name='RE-RUN2 Date of gel electrophoresis', null=True)
    rerun2_positive_control = models.TextField(verbose_name='RE-RUN2 Positive control', null=True)
    rerun2_negative_control = models.TextField(verbose_name='RE-RUN2 Negative control', null=True)
    rerun2_gel_electrophoresis_results = models.TextField(verbose_name='RE-RUN2 Gel electrophoresis result', null=True)
    rerun2_gel_photo_labeled = models.TextField(verbose_name='RE-RUN2 Gel photo - labeled', null=True)
    rerun2_date_confirmation_test = models.DateTimeField(verbose_name='RE-RUN2 Date of sequencing', null=True)
    rerun2_confirmation_test_results = models.TextField(verbose_name='RE-RUN2 Sequencing result', null=True)
    rerun2_confirmation_test_results_other = models.TextField(verbose_name='RE-RUN2 Sequencing result - if "Other"', null=True)
    rerun2_raw_cov_sequence_txt = models.TextField(verbose_name='RE-RUN2 Raw CoV sequence - .txt files', null=True)
    rerun2_raw_cov_sequence_ab1 = models.TextField(verbose_name='RE-RUN2 Raw CoV sequence - .ab1 files', null=True)
    rerun2_raw_cov_sequence_pdf = models.TextField(verbose_name='RE-RUN2 Raw CoV sequence - .pdf files', null=True)
    rerun2_aligned_cov_sequence_submitted_to_blast = models.TextField(verbose_name='RE-RUN2 Aligned CoV sequence (.fasta file) submitted to BLAST', null=True)
    rerun2_coronavirus_identified_blast = models.TextField(verbose_name='RE-RUN2 Coronavirus identified by BLAST', null=True)
    rerun2_query_cover_top_BLAST_match = models.FloatField(verbose_name='RE-RUN2 Query cover (%) for top BLAST match', null=True)
    rerun2_percent_identity_top_BLAST_match = models.FloatField(verbose_name='RE-RUN2 Percent identity (%) for top BLAST match', null=True)
    rerun2_screenshot_top_5_BLAST_matches = models.TextField(verbose_name='RE-RUN2 Screenshot photo of top 5 BLAST matches', null=True)
