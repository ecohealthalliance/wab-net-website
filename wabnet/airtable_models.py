...
class Screening(models.Model):
    ...
    rerun_positive_control_1 = models.TextField(verbose_name='RE-RUN Positive control 1', null=True)
    rerun_negative_control = models.TextField(verbose_name='RE-RUN Negative control', null=True)
    rerun_gel_electrophoresis_results = models.TextField(verbose_name='RE-RUN Gel electrophoresis results', null=True)
