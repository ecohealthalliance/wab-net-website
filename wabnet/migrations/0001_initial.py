# Generated by Django 2.0.6 on 2018-07-17 19:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='wabnet.BatData')),
            ],
        ),
        migrations.CreateModel(
            name='SiteData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_40_Number_of_26_mete_x', models.IntegerField(blank=True, null=True, verbose_name='Number of 2.6 meter nets')),
                ('x_41_Number_of_4_meter_x', models.IntegerField(blank=True, null=True, verbose_name='Number of 4 meter nets')),
                ('x_42_Number_of_6_meter_x', models.IntegerField(blank=True, null=True, verbose_name='Number of 6 meter nets')),
                ('x_43_Number_of_9_meter_x', models.IntegerField(blank=True, null=True, verbose_name='Number of 9 meter nets')),
                ('x_44_Number_of_harp_tr_x', models.IntegerField(blank=True, null=True, verbose_name='Number of harp traps')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wabnet.SiteData')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wabnet.BatData')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='batdata',
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wabnet.TrappingEvent'),
        ),
    ]
